...
public class Constant {
    ...
    //金币图片
    public static final String[] JINBI_IMG_PATH = {"resources/img/jinbi.png","resources/img/jinbi.png","resources/img/jinbi.png"};

    //道具的图片

    public static final String[] DAOJU_IMG_PATH = {"resources/img/jianfen.png","resources/img/jianfen.png","resources/img/jianfen.png"};
    ...
    public static final int JINBI_IMAGE_COUNT = 3; //金币图片个数

    public static final int DAOJV_IMAGE_COUNT = 3; //道具的个数

    public static final int JINBI_BORN_PERCENT = 5; //金币概率
    public static final int DAOJV_BORN_PERCENT = 2; //金币概率
